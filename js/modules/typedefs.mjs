...
export const StaticStatusType = {
    ...
    bloomBonus: "baseBloomBonus",
    hyperbloomBonus: "baseHyperbloomBonus",
    burgeonBonus: "baseBurgeonBonus",
    aggravateBonus: "baseAggravateBonus",
    spreadBonus: "baseSpreadBonus",
...
export const DynamicStatusType = {
    ...
    bloomBonus: "bloomBonus",
    hyperbloomBonus: "hyperbloomBonus",
    burgeonBonus: "burgeonBonus",
    aggravateBonus: "aggravateBonus",
