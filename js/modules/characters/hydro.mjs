                ...
                list: [
                    {
                        ...
                        value: (vmdata, calc, props) => calc.hp(props).mul(KamisatoAyato.skillTalentTable[vmdata.skillRank-1][3] * Number(vmdata.skillStacks))
                    }
                ]
            }
        });
...
export class Yelan extends Base.CharacterData
{
    ...
    //  0-3:通常4段, 4:狙撃, 5:フルチャージ, 6:落下, 7-0:低空, 7-1:高空, 8: 打破の矢
        [0.4068, 0.3904, 0.516, [0.3251, 0.3251], 0.4386, 1.240, 0.568, [1.140, 1.420], 0.1158], // lv. 1
        [0.4399, 0.4222, 0.558, [0.3515, 0.3515], 0.4743, 1.333, 0.615, [1.230, 1.530], 0.1244],
        [0.4739, 0.4540, 0.600, [0.3780, 0.3780], 0.5100, 1.426, 0.661, [1.320, 1.650], 0.1331],
        [0.5203, 0.4994, 0.660, [0.4158, 0.4158], 0.5610, 1.550, 0.727, [1.450, 1.820], 0.1447],
        [0.5534, 0.5312, 0.702, [0.4423, 0.4423], 0.5967, 1.643, 0.773, [1.550, 1.930], 0.1534],
        [0.5913, 0.5675, 0.750, [0.4725, 0.4725], 0.6375, 1.736, 0.826, [1.650, 2.060], 0.1621],
        [0.6433, 0.6174, 0.816, [0.5141, 0.5141], 0.6936, 1.860, 0.899, [1.800, 2.240], 0.1736],
        [0.6953, 0.6674, 0.882, [0.5557, 0.5557], 0.7497, 1.984, 0.971, [1.940, 2.430], 0.1852],
        [0.7473, 0.7173, 0.948, [0.5972, 0.5972], 0.8058, 2.108, 1.044, [2.090, 2.610], 0.1968],
        [0.8041, 0.7718, 1.020, [0.6426, 0.6426], 0.8670, 2.232, 1.123, [2.250, 2.810], 0.2084],
        [0.8609, 0.8263, 1.092, [0.6880, 0.6880], 0.9282, 2.356, 1.203, [2.400, 3.000], 0.2199] // lv. 11
    ];
    ...
    static presetAttacks = [
        ...
        {
            id: "normal_charged_breakthrough",
            label: "打破の矢",
            ref: TypeDefs.DynamicStatusType.hp,
            dmgScale: (vm) => vm.normalTalentRow()[8],
            attackProps: { isCharged: true, isHydro: true }
        },
        {
            id: "skill_dmg",
